	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while(rs.next()){
				...
				"			<form id=" + id + " action=\"http://107.23.136.184/FirstServlet/Actor\" method='post' style=\"overflow: hidden\">"+
				"  				<img = " + id + " src=" + picture + " class=\"card-img-top\" alt=" + name + " style=\"width: auto; height: 24.75rem; margin-left: auto; margin-right: auto; display: block\">"+
				"  					<div class=\"card-body\">"+
				"    					<h5 class=\"card-title\">" + name + " (" + age + ")</h5>" +
				"   						<a href=\"./Actor \">"+
				"   							<input type=\"hidden\" name=\"id\"	value= " + id + ">"+ userPass +
				"								<button type='submit' class='btn btn-primary'>View Actor</button>"+
				"							</a>"+
				"  					</div>"+
				"  			</form>"+
				"  		</div>"+
